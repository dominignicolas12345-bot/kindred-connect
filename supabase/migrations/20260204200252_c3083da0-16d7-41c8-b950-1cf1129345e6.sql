...
CREATE TABLE public.settings (
  ...
  institution_name TEXT DEFAULT 'Mi Institución',
  monthly_fee_base NUMERIC DEFAULT 0,
...
CREATE TABLE public.extraordinary_payments (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  extraordinary_fee_id UUID REFERENCES public.extraordinary_fees(id) ON DELETE CASCADE NOT NULL,
  member_id UUID REFERENCES public.members(id) ON DELETE CASCADE NOT NULL,
...
INSERT INTO public.settings (institution_name, monthly_fee_base) VALUES ('Mi Institución', 0);